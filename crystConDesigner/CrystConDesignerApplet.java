	...
	class GetPredictions extends Thread {
		...
		// Not pretty, but will do for now
			String[] urlNames = { "TEXT",
					"https://npsa-prabi.ibcp.fr/cgi-bin/secpred_sopma.pl",
					"https://npsa-prabi.ibcp.fr/cgi-bin/secpred_hnn.pl",
					"https://npsa-prabi.ibcp.fr/cgi-bin/secpred_mlr.pl",
					"https://npsa-prabi.ibcp.fr/cgi-bin/secpred_dpm.pl",
					"https://npsa-prabi.ibcp.fr/cgi-bin/secpred_dsc.pl",
					...
					"https://npsa-prabi.ibcp.fr/cgi-bin/secpred_simpa96.pl",
					"SEPARATOR", "TEXT", 
					...
					"SEPARATOR", "TEXT",
					"https://npsa-prabi.ibcp.fr/cgi-bin/primanal_lupas.pl",
